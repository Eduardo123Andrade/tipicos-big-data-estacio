...
crime_per_city_chart = crimes_per_city(city_ids=city_ids, crime_id=crime_id, initial_year=initial_year, final_year=final_year)

[pie_chart1]= st.columns(1)
bar_chart1, bar_chart2 = st.columns(2)

pie_chart1.plotly_chart(crime_per_city_chart)
bar_chart1.plotly_chart(crime_city_chart)
bar_chart2.plotly_chart(all_crimes_pie_chart)