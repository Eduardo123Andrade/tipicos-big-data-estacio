...
def crimes_city(crime_id, city_ids, initial_year=None, final_year=None):
  result = coc.get_crime_on_city(crime_id=crime_id, city_ids=city_ids, initial_year=initial_year, final_year=final_year)
